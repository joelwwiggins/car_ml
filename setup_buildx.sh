...
echo "docker buildx build --platform linux/arm64 -f Dockerfile.data -t obd2-collector:arm64 --load ."
echo "docker buildx build --platform linux/arm64 -f Dockerfile.monitor -t obd2-monitor:arm64 --load ."
echo ""
